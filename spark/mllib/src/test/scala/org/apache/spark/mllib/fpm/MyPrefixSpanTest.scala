...
object MyPrefixSpanTest {
  ...
  def main(args: Array[String]) {
    ...
    */
    ...
    //val sequences = sc.parallelize(Seq(Array(Array(1, 2, 3, 4, 5))), 2).cache()
    //val curSupport = 1
    ...
    */
    ...
    val prefixSpan = new PrefixSpan()
      ...
      .setMaxLocalProjDBSize(32000000L) //=> 0 for complete execution in RDD //6400000000L
      //.setCanUsePPIC(true)
      .setSubProblemLimit(0)
      .setMaxItemPerItemSet(0)
